...
\begin{theorem}[van Kampen's applied to 2-dimensional cell complexes]
...
our 1-skeleton, is also a loop that generates $N$. 

% TODO: difference between \pi A and \pi A \cap B - why is A just Z but A \cap
% B must respect the orientation of gluing

So our result is the group free in one generator modulo the relation $aa^1$:

\[\pi_1(P^2(\R)) \cong < a ~|~ aa^{-1} > \cong \Z_2.\]


% Thinking of loops on a mobius band
...
% Undestanding two-skeleton argument from hatcher

% Small connection to Spinors. Two 
% https://en.wikipedia.org/wiki/Plate_trick

%% https://groupoids.org.uk/popmath/cpm/sculpture/movies/mobius100.mp4
%% https://www.youtube.com/watch?v=mOO_IQznZCQ
