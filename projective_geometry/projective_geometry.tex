...
\begin{proof}
	...
	% TODO: linear independence is not convincing
	Furthermore, notice $c'' + a'' + b'' = 0$, and this expression holds for any scaled representation of
	these vectors, so they are linearly independent. 
